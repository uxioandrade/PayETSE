...
#define MAXLONXITUDE 255 //Utilizamos esta variable para definir la longitud de la cadena de carácteres de tipoclave
...
typedef struct{
    char receptor[MAXLONXITUDE];
    double cantidade;
    char concepto[MAXLONXITUDE];
} tipoelempila;
